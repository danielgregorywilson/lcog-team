...
export default class Schaefers1 extends Vue{
  ...
  private standardDesk: string = require('../../assets/floorPlans/desk-standard.png') as string // eslint-disable-line @typescript-eslint/no-var-requires
  private ergoDesk: string = require('../../assets/floorPlans/desk-ergo.png') as string // eslint-disable-line @typescript-eslint/no-var-requires
