...
from people.models import (
    Desk, DeskReservation, Employee, PerformanceReview, Responsibility, ReviewNote, Signature,
...
from people.serializers import (
    ...
    TeleworkApplicationSerializer, TeleworkSignatureSerializer, UserSerializer,
...
class DeskReservationViewSet(viewsets.ModelViewSet):
    ...
    API endpoint for desk reservations.
    """
    queryset = DeskReservation.objects.all()
