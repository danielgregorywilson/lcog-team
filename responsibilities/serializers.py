...
class SimpleResponsibilitySerializer(serializers.HyperlinkedModelSerializer):
    # For use by TagSerializer - does not have url or tags
    ...
    class Meta:
        ...
        fields = [
            'pk', 'name', 'description', 'link', 'primary_employee_pk',
...
class TagSerializer(serializers.HyperlinkedModelSerializer):
    ...
    def get_responsibilities(self, tag):
        ...
        serializer = SimpleResponsibilitySerializer(
