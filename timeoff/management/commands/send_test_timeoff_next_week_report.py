...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if num_tor_days == 0:
            message = f'No time off notifications sent to the test unit.'
        else:
            message = f'Sent notification of {num_tor_days} time off requests to {num_employees} test employees.'
